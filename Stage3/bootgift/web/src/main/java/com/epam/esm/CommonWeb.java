...
public class CommonWeb {
    ...
    public static final String DEF_PAGE = "0";
    ...
    public static Pageable getPagebale(String page, String pSize, Sort sort) throws LocalAppException {
        if (page == null) {
            page = DEF_PAGE;
        ...
        return PageRequest.of(Integer.parseInt(page), Integer.parseInt(pSize), sort);
    }
